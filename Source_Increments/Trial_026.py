...
class ControlFlowGraph:
    ...
    def add_edge(self, u, v):
        ...
        if not re.match(r'^[\w-]+$', u) or not re.match(r'^[\w-]+$', v) or any(ord(c) < 32 for c in u+v):
            raise ValueError(f"Invalid node name: '{u}' or '{v}' (contains spaces, control characters, or special symbols)")
