...
class ControlFlowGraph:
    def __init__(self):
        ...
        self.all_edges = set()  # Track all edges for correct complexity calculation

    def add_edge(self, u, v):
        # Add a directed edge from node u to node v
        self.graph[u].append(v)
        self.edges.add((u, v))  # Store edge for complexity calculation
        self.all_edges.add((u, v))  # Track all edges globally
    ...
    def _extract_basis_set(self):
        ...
        for path in self.paths:
            ...
            # Ensure we collect at least cyclomatic complexity number of paths
